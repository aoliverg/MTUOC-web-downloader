...
def download_from_sitemap(sitemapfile, nofollow, minwait, maxwait, maxdowload, outdir, strategy, timeout):
...
if __name__ == "__main__":
    ...
    download_from_sitemap(sitemapfile, nofollow, minwait, maxwait, maxdowload, outdir, strategy, timeout)
